...
VehicleCommand QuadControl::GenerateMotorCommands(float collThrustCmd, V3F momentCmd)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
    float l = L / sqrtf(2.f);
    float f_r_x = momentCmd.x / l;
    float f_r_y = momentCmd.y / l;
    float f_r_z = - momentCmd.z / kappa;
    float thrust = collThrustCmd;
    cmd.desiredThrustsN[0] = ( f_r_x + f_r_y + f_r_z + thrust)/4.f;
    cmd.desiredThrustsN[1] = (-f_r_x + f_r_y - f_r_z + thrust)/4.f;
    cmd.desiredThrustsN[2] = ( f_r_x - f_r_y - f_r_z + thrust)/4.f;
    cmd.desiredThrustsN[3] = (-f_r_x - f_r_y + f_r_z + thrust)/4.f;
...
V3F QuadControl::RollPitchControl(V3F accelCmd, Quaternion<float> attitude, float collThrustCmd)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
    ...
    V3F b_err = b_cmd - V3F(R(0,2), R(1,2), 0.f);
    V3F b_cmd_dot = kpBank * b_err;
